...
export const AuthView = () => {
    ...
    return (
        <div className="container mt-5 col-md-8">
            <h1 className="text-center mb-4" id="welcome-heading">{labels.welcome}</h1>
            {/* Tab Navigation */}
            <ul className="nav nav-tabs justify-content-center mb-4" role="tablist" aria-label="Selezione autenticazione">
